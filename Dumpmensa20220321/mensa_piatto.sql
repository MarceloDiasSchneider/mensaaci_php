...
CREATE TABLE `piatto` (
  ...
  `id_tipologia_piatto` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `piatto` VALUES (4,'pasta coi fagioli','1'),(5,'pasta e ceci','1'),(6,'salsiccia','2'),(7,'test2 piatto','1'),(8,'piatto finale','1'),(9,'piatto finale 2','1'),(10,'pasta e patate','1'),(11,'cotolette milanese','2');
