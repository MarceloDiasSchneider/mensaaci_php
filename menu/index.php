...
include_once('../piatto/piatto_class.php');
$piatto_collection = new piatto_class(); //recupero dati principali
$piattoFound = $piatto_collection->getAll();
?>
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <p class='h2 text-c-silver-dark fw-bold'>Gestione menu</p>
                        <p class='h5 text-c-silver-ligth'>Visualizza la lista dei menu registrati</p>
                    </div>
                    <div class="col-md-4 offset-md-4 ">
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#ModalPost" aria-controls="ModalPost" aria-expanded="false" aria-label="new pippo" id="button-newIngredient">Nuovo menu
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id='formMenu'>
                        ...
                        <div class="list-group m-2">
                            <div class="list-group-item d-flex p-0 w-100 bg-white">
                                <div class="input-group w-100">
                                    <input type='text' name='nomeMenu' id='nomeMenu' class="form-control bg-transparent border-0" required>
                                </div>
                            </div>
                            <div class="form-check my-2">
                                <input class="form-check-input" type="checkbox" name="takeaway" value="1" id="takeaway">
                        ...
                        <ol id="selectable">
                            <?php foreach ($piattoFound as $piatto) {
                                echo " <li class=\"ui-widget-content\" id=" . $piatto['id'] . ">&nbsp;  " . $piatto['piatto'] . "</li>";
                            } ?>
                        </ol>
                        </p>
                        <input type='hiddens' name='piattiscelti' id='piattiscelti'>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#formMenuPut").on("submit", function(event) {
                event.preventDefault();
                var formValues = $(this).serialize();
                $.post("action.php", formValues, function(data) {
                    $("#result").html(data);
            ...
            $('#griglia_riepilogo').on('click', '.modificaPiatto', function() {
                ...
                $.post('action.php', {
                    ...
                    var menu;
                    var allergene;
                    $('#nomeMenu').val(data[0]['menu']);
                }, 'json');
            });
            $('#griglia_riepilogo').on('click', '.eliminaMenu', function() {
                var idmenu = $(this).val();
                var mielimini = confirm('Sei sicuro di voler eliminare questo menu');
                if (mielimini === true) {
                    $.post('action.php', {
                        id: idmenu,
                        action: 'delete'
